...
* Mautic versions 5.0.0 - 6.0.7 (Use previous [Whitelabeler 1.0](https://github.com/nickian/mautic-whitelabeler/releases) release for Mautic 2.x - 4.x. Beta versions are not tested.)
